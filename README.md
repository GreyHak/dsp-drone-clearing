...
### v1.4.7
 - Will now run with Dyson Sphere Program 0.9.24.11192 update.  Prototype change with no functional change.
### v1.4.6
 - Will now run with Dyson Sphere Program 0.8.23.9808 update.  Routine swap only.
### v1.4.5
